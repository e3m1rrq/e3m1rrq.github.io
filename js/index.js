function help(){
  ...
  <td></td>\
  <td>🇬🇧/🇺🇸 C1 Level - Upper Intermediate English</td>\
  </tr>\
  <td></td>\
  ...
  function jsu(){
    return "<p> doing this in 2024?? damn.</p>";
  }
  ...
  function fun(){
    return "<h2><span style=\"color:#676f9d;\">Fun:</span></h2><table>\
      <tr>\
        <td>jsu</td>\
      ...
      <td>roulette</td>\
      <td>You can play Roulette.</td>\
    </tr>\
    <tr>\
    <td>bj</td>\
      <td>You can play BlackJack.</td>\
    </tr>\
    <tr>\
    <td>uno</td>\
      <td>You can play UNO.</td>\
    </tr>\
      <tr>\
      <td>lweather</td>\
  ...
  function projects(){
    return "<h2><span style=\"color:#676f9d;\">Projects:</span></h2><table>\
      <tr>\
        <td>bmi</td>\
      ...
      <tr>\
      <td>weather</td>\
        <td>Shows The Weather By Location.</td>\
      </tr>\
      <tr>\
      <td>qr</td>\
        <td>Generates QR Code.</td>\
      </tr>\
      <tr>\
      </tr></table>";
  }
  ...
  function commandProcessor(e){
    ...
    if(e.keyCode == 13){
      ...
      if(txtInput == "help"){
      ...
      }else if (txtInput == "lweather") {
        document.getElementById('injected').innerHTML=lweather();
        ...
        var win = window.open("rulet.html", '_blank');
        win.focus();
      }else if (txtInput == "bj") {
        var win = window.open("bj.html", '_blank');
        win.focus();
      }else if (txtInput == "uno") {
        var win = window.open("uno.html", '_blank');
        win.focus();
      }else if (txtInput == "projects") {
        document.getElementById('injected').innerHTML=projects();
      }else if (txtInput == "bmi") {
        var win = window.open("bmi.html", '_blank');
        win.focus();
      }else if (txtInput == "qr") {
        var win = window.open("qrcode.html", '_blank');
        win.focus();
      }else if (txtInput == "malazra") {
        var win = window.open("azra.html", '_blank');
        win.focus();
      }else if (txtInput == "weather") {
        var win = window.open("weather.html", '_blank');
        win.focus();
      }else{
        document.getElementById('injected').innerHTML = help();
      }
