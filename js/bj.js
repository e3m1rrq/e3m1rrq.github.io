...
App.prototype = (function() { var pro = {};
  ...
  var showMessage = function ( status )
  {
      ...
      switch ( status ) {
        ...
        case 'win-dealer-busted': content = 'You WIN<span>Dealer Lost</span>'; break;
        case 'lose': content = 'You LOSE'; break;
        case 'lose-blackjack': content = 'You LOSE<span>Blackjack</span>'; break;
        case 'lose-busted': content = 'You Lose<span>Dealer Won</span>'; break;
        case 'push': content = 'Tie<span>No Winner</span>'; break;
        case 'game-over': content = 'Game Over'; break;
        default: content = '<span>Hmm.??</span>'; break;
      }
